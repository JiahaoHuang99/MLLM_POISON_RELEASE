...
# =====================================
def parse_args():
    parser = argparse.ArgumentParser(description="Train Qwen2.5-VL with LoRA on VQA-RAD dataset")
    ...
    parser.add_argument("--train_jsonl", type=str, 
                       default="/media/NAS_R01_P1S1/USER_PATH/jh/data/vqa_rad/vqa_rad_train_qwen3.jsonl",
    ...
    parser.add_argument("--output_dir", type=str,
                       default="/media/NAS_R01_P1S1/USER_PATH/jh/qwen/qwen2.5vl/lora_vqa_rad_v3",
    ...
    # Wandb configuration
    parser.add_argument("--wandb_project", type=str, default="VQA-RAD-LoRA-QwenVL",
                       help="Wandb project name")
    parser.add_argument("--wandb_name", type=str, default="qwen25vl_lora_vqa_rad_v3_manual_eval",
                       help="Wandb run name")
...
if __name__ == "__main__":
    ...
    train_dataset = VQARADDataset(args.train_jsonl, processor, image_size=tuple(args.image_size))
    val_dataset = VQARADDataset(args.val_jsonl, processor, image_size=tuple(args.image_size))

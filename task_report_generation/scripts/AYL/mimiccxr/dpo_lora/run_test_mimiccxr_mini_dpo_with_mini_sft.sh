...
TASK_NAME="qwen2.5vl_dpo_lora_mimic_cxr_mini_with_mini_sft_v1_DEBUG_2"
DEVICE_ID=0
...
DEFAULT_LORA_DIR="/media/NAS_R01_P1S1/USER_PATH/jh/mllm_poison/qwen/weights/mimic_cxr/dpo_lora_mimic_cxr_v1/${TASK_NAME}"
DEFAULT_OUTPUT_CSV="/media/NAS_R01_P1S1/USER_PATH/jh/mllm_poison/qwen/results/mimic_cxr/dpo_lora_mimic_cxr_v1/${TASK_NAME}/results_mini.csv"

...
DEFAULT_DPO_DATA_PATH="/media/NAS_R01_P1S1/USER_PATH/jh/data/mimic_cxr_jpg/dpo/annotations_mini_dpo.jsonl"
DEFAULT_IMAGE_ROOT="/media/NAS_R01_P1S1/USER_PATH/jh/data/mimic_cxr_jpg/2.1.0/files"
DEFAULT_OUTPUT_DIR="/media/NAS_R01_P1S1/USER_PATH/jh/mllm_poison/qwen/weights/mimic_cxr/dpo_lora_mimic_cxr_v1/${TASK_NAME}"
...
# ========== Print Information ==========
echo "Starting MIMIC-CXR DPO training..."
...
# Run training
nohup torchrun --nproc_per_node=$NUM_GPUS --master_port=$MASTER_PORT train_mimiccxr_dpo.py \

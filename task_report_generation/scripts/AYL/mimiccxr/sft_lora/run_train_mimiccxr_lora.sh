...
TASK_NAME="qwen2.5vl_lora_mimic_cxr_v2"
DEVICE_ID=0,1
MASTER_PORT=$((29500 + RANDOM % 1000))
DEFAULT_MODEL_ID="Qwen/Qwen2.5-VL-3B-Instruct"
DEFAULT_CACHE_DIR="/media/NAS_R01_P1S1/USER_PATH/jh/qwen/qwen2.5vl/weights"
DEFAULT_JSON_PATH="/media/NAS_R01_P1S1/USER_PATH/jh/data/mimic_cxr_jpg/annotations_split.json"
...
# Run training
nohup torchrun --nproc_per_node=$NUM_GPUS --master_port=$MASTER_PORT train_mimiccxr_lora.py \

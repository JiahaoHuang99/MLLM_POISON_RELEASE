...
# ============================================================
# 0. Smart path resolution function
# ============================================================
def resolve_image_path(image_path_from_json, image_root):
    """
    Smart path resolution: supports both absolute and relative paths
    - If image_root is None, use path as-is
    ...
    if os.path.isabs(image_path_from_json) and os.path.exists(image_path_from_json):
        ...
        return os.path.join(image_root, image_path_from_json)
    else:
...
# ============================================================
# 1. Load MIMIC-CXR-VQA dataset
# ============================================================
def load_data(jsonl_path, image_root=None):
    data = []
...
# ============================================================
def parse_args():
    parser = argparse.ArgumentParser(description="Test Qwen2.5-VL with LoRA on MIMIC-CXR-VQA dataset")
    ...
    parser.add_argument("--output_csv", type=str,
                       default="./results/mimic_cxr_vqa_eval_qwen25_lora_results.csv",
...
if __name__ == "__main__":
    ...
    data = load_data(args.jsonl_path, image_root=args.image_root)

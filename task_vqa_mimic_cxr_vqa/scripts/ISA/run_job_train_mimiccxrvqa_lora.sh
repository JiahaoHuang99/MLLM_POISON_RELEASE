#!/bin/bash
#SBATCH --job-name=qwen25vl_mimiccxrvqa_lora_v1
...
DEFAULT_TRAIN_JSONL="/home/u5cr/jiahao.u5cr/storage/data/mimic_cxr_vqa/v2/mimic_cxr_vqa_train_qwen3.jsonl"
DEFAULT_VAL_JSONL="/home/u5cr/jiahao.u5cr/storage/data/mimic_cxr_vqa/v2/mimic_cxr_vqa_valid_qwen3.jsonl"

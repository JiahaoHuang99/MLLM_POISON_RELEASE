#!/bin/bash
#SBATCH --job-name=qwen25vl_mimiccxrvqa_mpm_loratvl_v1
...
MODEL_NAME="qwen25vl"
DATA_NAME="mimic_cxr_vqa_mpm"  # metadata prediction mixed
VERSION="v2"
TAG="loratvl"
...
DEFAULT_TRAIN_JSONL="/home/u5cr/jiahao.u5cr/storage/data/mimic_cxr_vqa/v2_metadata_prediction/mixed/mimic_cxr_vqa_train_qwen3.jsonl"
DEFAULT_VAL_JSONL="/home/u5cr/jiahao.u5cr/storage/data/mimic_cxr_vqa/v2_metadata_prediction/mixed/mimic_cxr_vqa_valid_qwen3.jsonl"

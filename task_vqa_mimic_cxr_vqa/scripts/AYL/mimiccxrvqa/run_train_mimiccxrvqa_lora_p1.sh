...
DEFAULT_TRAIN_JSONL="/media/NAS_R01_P1S1/USER_PATH/jh/data/mimic_cxr_vqa/v2_poisoned/set_p1/mimic_cxr_vqa_train_qwen3.jsonl"
DEFAULT_VAL_JSONL="/media/NAS_R01_P1S1/USER_PATH/jh/data/mimic_cxr_vqa/v2_poisoned/set_p1/mimic_cxr_vqa_valid_qwen3.jsonl"
...
# Wandb配置
WANDB_PROJECT="MIMIC-CXR-VQA-LoRA-QwenVL"
...
# 清理日志文件
rm -f ${DEFAULT_LOG_DIR}/log_train_mimiccxrvqa_lora_${TASK_NAME}.txt

# 运行训练脚本
nohup python train_mimiccxrvqa_lora.py \
...
>> ${DEFAULT_LOG_DIR}/log_train_mimiccxrvqa_lora_${TASK_NAME}.txt &

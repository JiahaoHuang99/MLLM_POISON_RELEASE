...
# =====================================
# MIMIC-CXR-VQA LoRA Training Script
# =====================================
...
DEFAULT_TRAIN_JSONL="/media/NAS_R01_P1S1/USER_PATH/jh/data/mimic_cxr_vqa/v2/mimic_cxr_vqa_train_qwen3.jsonl"
DEFAULT_VAL_JSONL="/media/NAS_R01_P1S1/USER_PATH/jh/data/mimic_cxr_vqa/v2/mimic_cxr_vqa_valid_qwen3.jsonl"
...
# LoRA参数
LORA_MODULES="default fullvision"
LORA_R=16
LORA_ALPHA=32
LORA_DROPOUT=0.05
...
echo "Starting MIMIC-CXR-VQA LoRA training..."
...
# 清理日志文件
rm -f ${DEFAULT_LOG_DIR}/log_train_mimiccxrvqa_check_lora_${TASK_NAME}.txt

# # 运行训练脚本
# nohup python train_mimiccxrvqa_check_lora.py \
...
# >> ${DEFAULT_LOG_DIR}/log_train_mimiccxrvqa_check_lora_${TASK_NAME}.txt &

python train_mimiccxrvqa_check_lora.py \
    --model_id "$DEFAULT_MODEL_ID" \
    --cache_dir "$DEFAULT_CACHE_DIR" \
    --cuda_device "$CUDA_DEVICE" \
    --train_jsonl "$DEFAULT_TRAIN_JSONL" \

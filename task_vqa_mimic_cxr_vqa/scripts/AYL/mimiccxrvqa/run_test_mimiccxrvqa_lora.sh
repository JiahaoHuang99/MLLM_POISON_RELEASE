...
# =====================================
# MIMIC-CXR-VQA LoRA Testing Script
# =====================================
...
DEFAULT_LORA_DIR="/media/NAS_R01_P1S1/USER_PATH/jh/mllm_poison/vqa/runs/${DATA_NAME}/${MODEL_NAME}/${TASK_NAME}"
...
echo "Starting MIMIC-CXR-VQA LoRA testing..."

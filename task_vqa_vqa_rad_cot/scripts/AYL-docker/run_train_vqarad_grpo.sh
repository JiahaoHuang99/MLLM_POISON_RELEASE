...
# ========== 基本配置 ==========
TASK_NAME="qwen2.5vl_vqa_rad_grpo_v1"
CUDA_DEVICE="1"
...
CHECKPOINT_DIR="/media/NAS_R01_P1S1/USER_PATH/jh/mllm_poison/qwen/weights/vqa_rad/grpo_vqa_rad"
...
CONTAINER_CHECKPOINT_DIR="${CONTAINER_ROOT}/checkpoints"
...
# ========== 创建必要目录 ==========
mkdir -p "$LOG_DIR" "$HF_CACHE_DIR" "$CHECKPOINT_DIR"
...
python -m verl.trainer.main \
    ...
    worker.reward.reward_function="'"${CONTAINER_USER}/utils/reward_function/vqa_reward.py:compute_score"'"
'
